const textArray = {
  ...
  body: `
      ...
      `,
  bodyAppend: `<p>The wonderful Grundy Mack customers who spent over £20,000,000 with us since 1991 keep coming back to buy again. Their good experience brought us repeat business. We've always been a company with a strong sense of social responsibility. When we say we care, we mean it. Now we're Classic &amp; Sportscar Centre. Like it says on the label, we sell Classics and Sportscars. We'll sell yours too if you let us. We did a good job in the past. We aim to do a really great one as Classic and Sportscar Centre!</p>`,
  box1: `<h3 class="title-dont">To Don't</h3><ul class="ul-bullets"><li>Don't tell lies about anything</li><li>Don't make promises you can't keep</li><li>If in doubt, don't buy it</li><li>Don't cut corners where safety is concerned</li></ul>`,
  box2: `<h3 class="title-do">To Do</h3><ul class="ul-bullets"><li>Tell the truth (even when stranger than fiction!)</li><li>Describe the cars honestly</li><li>Be fair</li><li>Listen</li><li>Keep your promises</li></ul>`
};
