const catArray = {
  General: {
    ...
    description: "Selling classic cars worldwide for over 30 years.",
    slug: "/",
  ...
  Live: {
    ...
    titleHover: "Link to our classic car showroom page",
    titleDocument: "Classic Cars For Sale in Malton, North Yorkshire",
    description: "Supplying classic cars worldwide for over 30 years.",
  ...
  Archive: {
    ...
    description: "Since 1991, we've sold more than £100,000,000 of classic vehicles.",
  ...
  Press: {
    ...
    description: "Classic & Sportscar Centre Magazine Articles",
    slug: "/press",
  ...
  News: {
    ...
    description: "See what's going on at Classic & Sportscar Centre",
    slug: "/news",
  ...
  Restoration: {
    ...
    description: "We also offer a wide range of classic car maintenance and restoration services.",
  ...
  Videos: {
    ...
    titleDocument: "",
    description: "Classic & Sportscar Centre on YouTube",
    text: "",
    slug: "/videos",
  ...
  Staff: {
    ...
    description: "We have more than 30 staff across several departments; Accounts, Bodyshop, Sales, Trim, and Workshop",
    text: "",
    slug: "/staff",
